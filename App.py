...
class MainWindows():
    def __init__(self):
        ...
        self.release_date = tk.Label(self.VersionInfo,text="發布日期 : 2023-07-16" ,font=("標楷體", 12))
        ...
        self.ChangeInfo_content = tk.Label(self.ChangeInfo,text="增加國軍中清、中榮VPN功能",font=("標楷體", 8))
