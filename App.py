...
class MainWindows():
    def __init__(self):
        ...
        self.version_text = tk.Label(self.VersionInfo,text="版本 : v3.2.1" ,font=("標楷體", 12))
        ...
        self.release_date = tk.Label(self.VersionInfo,text="發布日期 : 2023-2-25" ,font=("標楷體", 12))
        ...
        self.ChangeInfo_content = tk.Label(self.ChangeInfo,text="修正中國醫學大學系列不截圖問題\n將各醫院轉換回網頁模式(中國醫系列除外)",font=("標楷體", 8))
    ...
    def Start(self):
        ...
        self.URLList = {
            ...
            #api+vpn"豐原醫院" : FYH(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"太平長安醫院" : EVERAN(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"清泉醫院" : CHINGCHYUAN(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"烏日林新醫院" : WLSHOSP(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"國軍醫院-中清" : TAFGHZB(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"國軍醫院-台中" : TAFGH(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"中山醫" : CSH(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
            #api+vpn"台中榮總" : VGHTC(self.browser,self,self.beginPage.get(),self.beginNum.get(),self.endPage.get(),self.endNum.get(),self.outputPath,self.filePath),
