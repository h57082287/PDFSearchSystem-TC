...
class MainWindows():
    def __init__(self):
        ...
        self.release_date = tk.Label(self.VersionInfo,text="發布日期 : 2023-03-17" ,font=("標楷體", 12))
        ...
        self.ChangeInfo_content = tk.Label(self.ChangeInfo,text="修正澄清中港發生清除cookie的Timeout問題",font=("標楷體", 8))
