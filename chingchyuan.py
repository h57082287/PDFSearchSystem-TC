...
class CHINGCHYUAN():
    ...
    def _getReslut(self,name:str, ID:str, year:str, month:str, day:str):
        ...
        with httpx.Client(http2=True) as client :
            # 進入網頁
            respone = client.post('http://webreg.ching-chyuan.com.tw:81/OReg/GetPatInfo', data=self.payload, headers=self.headers)
            if(respone.json()[0]['msg'] == "病患不存在"):
                ...
                respone = client.get('http://webreg.ching-chyuan.com.tw:81/OReg/ScheduledRecords')
                respone2 = client.post('http://webreg.ching-chyuan.com.tw:81/OReg/GetEventsByCondition', data=self.payload2, headers=self.headers)
